...
private void CrearEntidad(Vector3 p)
{
    ...
    switch(n)
    {
        ...
        {
            TimeReference=1080f,SeparationThreshold=0.72f,MaxScale=1f,GrowthTime=0f,GrowthDuration=1080f*0.72f,TimeSinceLastDivision=0f,DivisionInterval=1080f*0.72f,HasGeneratedChild=false,Parent=Entity.Null,IsInitialCell=true,SeparationSign=0
        }
        );
        ...
        {
            TimeReference=5400f,SeparationThreshold=0.65f,MaxScale=5f,GrowthTime=0f,GrowthDuration=5400f*0.65f,TimeSinceLastDivision=0f,DivisionInterval=5400f*0.65f,HasGeneratedChild=false,Parent=Entity.Null,IsInitialCell=true,SeparationSign=0
        }
        );
        break;
