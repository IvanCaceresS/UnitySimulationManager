...
private void CrearEntidad(Vector3 p)
{
    ...
    if(n=="SCerevisiae")
    {
        ...
        {
            TimeReference=3000f,SeparationThreshold=0.8f,MaxScale=5f,GrowthTime=0f,GrowthDuration=3000f*0.8f,TimeSinceLastDivision=0f,DivisionInterval=3000f*0.8f,HasGeneratedChild=false,Parent=Entity.Null,IsInitialCell=true,SeparationSign=0
        }
        );
    }
    else
