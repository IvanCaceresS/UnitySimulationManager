...
private void CrearEntidad(Vector3 p)
{
    ...
    switch(n)
    {
        ...
        {
            TimeReference=960f,SeparationThreshold=0.6f,MaxScale=1f,GrowthTime=0f,GrowthDuration=960f*0.6f,TimeSinceLastDivision=0f,DivisionInterval=960f*0.6f,HasGeneratedChild=false,Parent=Entity.Null,IsInitialCell=true,SeparationSign=0
        }
        );
        break;
        case "SCerevisiae":entityManager.AddComponentData(e,new SCerevisiaeComponent
        {
            TimeReference=5400f,SeparationThreshold=0.85f,MaxScale=5f,GrowthTime=0f,GrowthDuration=5400f*0.85f,TimeSinceLastDivision=0f,DivisionInterval=5400f*0.85f,HasGeneratedChild=false,Parent=Entity.Null,IsInitialCell=true,SeparationSign=0
        }
        );
        break;
