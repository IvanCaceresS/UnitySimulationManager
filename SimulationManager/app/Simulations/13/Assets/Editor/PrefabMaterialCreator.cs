...
public static class PrefabMaterialCreator
{
    ...
    [MenuItem("Tools/Crear Prefabs y Materiales")]public static void CreatePrefabsAndMaterials()
    {
        ...
        CPAM("EColi_1",PrimitiveType.Capsule,new Vector3(.5f,2,0.5f),new Vector3(90,0,0),1);
        CPAM("EColi_2",PrimitiveType.Capsule,new Vector3(.5f,2,0.5f),new Vector3(90,0,0),1);
    ...
    static void CPAM(string n,PrimitiveType t,Vector3 s,Vector3 r,int c)
    {
        ...
        m.color=n=="EColi_1"?new Color(0,1,0,1):n=="EColi_2"?new Color(1,1,0,1):Color.white;
