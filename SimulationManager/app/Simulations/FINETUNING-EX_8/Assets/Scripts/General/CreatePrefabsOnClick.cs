...
private void CrearEntidad(Vector3 p)
{
    ...
    switch(n)
    {
        ...
        {
            TimeReference=1140f,SeparationThreshold=0.72f,MaxScale=1f,GrowthTime=0f,GrowthDuration=1140f*0.72f,TimeSinceLastDivision=0f,DivisionInterval=1140f*0.72f,HasGeneratedChild=false,Parent=Entity.Null,IsInitialCell=true,SeparationSign=0
        }
        );
        break;
        case "SCerevisiae":entityManager.AddComponentData(e,new SCerevisiaeComponent
        {
            TimeReference=4200f,SeparationThreshold=0.78f,MaxScale=5f,GrowthTime=0f,GrowthDuration=4200f*0.78f,TimeSinceLastDivision=0f,DivisionInterval=4200f*0.78f,HasGeneratedChild=false,Parent=Entity.Null,IsInitialCell=true,SeparationSign=0
        }
        );
        break;
