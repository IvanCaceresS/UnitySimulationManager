...
private void CrearEntidad(Vector3 p)
{
    ...
    switch(n)
    {
        ...
        {
            TimeReference=1080f,SeparationThreshold=0.55f,MaxScale=1f,GrowthTime=0f,GrowthDuration=1080f*0.55f,TimeSinceLastDivision=0f,DivisionInterval=1080f*0.55f,HasGeneratedChild=false,Parent=Entity.Null,IsInitialCell=true,SeparationSign=0
        }
        );
        ...
        {
            TimeReference=2100f,SeparationThreshold=0.6f,MaxScale=5f,GrowthTime=0f,GrowthDuration=2100f*0.6f,TimeSinceLastDivision=0f,DivisionInterval=2100f*0.6f,HasGeneratedChild=false,Parent=Entity.Null,IsInitialCell=true,SeparationSign=0
        }
        );
        break;
