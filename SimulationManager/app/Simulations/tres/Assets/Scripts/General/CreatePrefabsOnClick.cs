...
private void CrearEntidad(Vector3 p)
{
    ...
    switch(n)
    {
        ...
        {
            TimeReference=1320f,SeparationThreshold=0.75f,MaxScale=1f,GrowthTime=0f,GrowthDuration=1320f*0.75f,TimeSinceLastDivision=0f,DivisionInterval=1320f*0.75f,HasGeneratedChild=false,Parent=Entity.Null,IsInitialCell=true,SeparationSign=0
        }
        );
        ...
        break;
        case "SCerevisiae_1":entityManager.AddComponentData(e,new SCerevisiaeComponent
        {
            TimeReference=5400f,SeparationThreshold=0.6f,MaxScale=5f,GrowthTime=0f,GrowthDuration=5400f*0.6f,TimeSinceLastDivision=0f,DivisionInterval=5400f*0.6f,HasGeneratedChild=false,Parent=Entity.Null,IsInitialCell=true,SeparationSign=0
        }
        );
        break;
        case "SCerevisiae_2":entityManager.AddComponentData(e,new SCerevisiaeComponent
        {
            TimeReference=7200f,SeparationThreshold=0.85f,MaxScale=5f,GrowthTime=0f,GrowthDuration=7200f*0.85f,TimeSinceLastDivision=0f,DivisionInterval=7200f*0.85f,HasGeneratedChild=false,Parent=Entity.Null,IsInitialCell=true,SeparationSign=0
        }
        );
        break;
...
private void AddPhysicsComponents(Entity e,string n,float s)
{
    ...
    switch(n)
    {
        ...
        break;
        case "SCerevisiae_1":case "SCerevisiae_2":c=Unity.Physics.SphereCollider.Create(new SphereGeometry
        {
