...
public static class PrefabMaterialCreator
{
    ...
    [MenuItem("Tools/Crear Prefabs y Materiales")]public static void CreatePrefabsAndMaterials()
    {
        ...
        CPAM("SCerevisiae_1",PrimitiveType.Sphere,new Vector3(5,5,5),new Vector3(90,0,0),0);
        CPAM("SCerevisiae_2",PrimitiveType.Sphere,new Vector3(5,5,5),new Vector3(90,0,0),0);
    ...
    static void CPAM(string n,PrimitiveType t,Vector3 s,Vector3 r,int c)
    {
        ...
        m.color=n=="EColi"?new Color(0.314f,0.784f,0.471f,1):n=="SCerevisiae_1"?new Color(0.937f,0.682f,0.682f,1):n=="SCerevisiae_2"?new Color(0.545f,0.271f,0.075f,1):Color.white;
