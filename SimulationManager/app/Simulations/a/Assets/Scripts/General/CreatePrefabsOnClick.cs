...
private void CrearEntidad(Vector3 p)
{
    ...
    switch(n)
    {
        case "EColi_1":entityManager.AddComponentData(e,new EColi_1Component
        {
            TimeReference=1080f,SeparationThreshold=0.65f,MaxScale=1f,GrowthTime=0f,GrowthDuration=1080f*0.65f,TimeSinceLastDivision=0f,DivisionInterval=1080f*0.65f,HasGeneratedChild=false,Parent=Entity.Null,IsInitialCell=true,SeparationSign=0
        }
        );
        ...
        break;
        case "EColi_2":entityManager.AddComponentData(e,new EColi_2Component
        {
            TimeReference=1920f,SeparationThreshold=0.78f,MaxScale=1f,GrowthTime=0f,GrowthDuration=1920f*0.78f,TimeSinceLastDivision=0f,DivisionInterval=1920f*0.78f,HasGeneratedChild=false,Parent=Entity.Null,IsInitialCell=true,SeparationSign=0
        }
        );
        entityManager.AddComponent(e,typeof(NonUniformScale));
        entityManager.SetComponentData(e,new NonUniformScale
...
private void AddPhysicsComponents(Entity e,string n,float s)
{
    ...
    switch(n)
    {
        case "EColi_1":case "EColi_2":c=Unity.Physics.CapsuleCollider.Create(new CapsuleGeometry
        {
