...
private void CrearEntidad(Vector3 p)
{
    ...
    switch(n)
    {
        ...
        {
            TimeReference=1680f,SeparationThreshold=0.72f,MaxScale=1f,GrowthTime=0f,GrowthDuration=1680f*0.72f,TimeSinceLastDivision=0f,DivisionInterval=1680f*0.72f,HasGeneratedChild=false,Parent=Entity.Null,IsInitialCell=true,SeparationSign=0
        }
        );
        break;
        case "EColi_2":entityManager.AddComponentData(e,new EColi_2Component
        {
            TimeReference=2520f,SeparationThreshold=0.65f,MaxScale=1f,GrowthTime=0f,GrowthDuration=2520f*0.65f,TimeSinceLastDivision=0f,DivisionInterval=2520f*0.65f,HasGeneratedChild=false,Parent=Entity.Null,IsInitialCell=true,SeparationSign=0
        }
        );
        break;
