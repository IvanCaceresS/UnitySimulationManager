...
public partial class EColi_1System : SystemBase
{
    protected override void OnUpdate()
    {
        ...
        Dependency=Entities.WithReadOnly(parentMap).ForEach((Entity entity,int entityInQueryIndex,ref LocalTransform transform,ref EColi_1Component organism)=>
        {   
