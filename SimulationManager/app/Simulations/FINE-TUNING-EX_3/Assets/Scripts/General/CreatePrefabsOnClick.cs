...
private void CrearEntidad(Vector3 p)
{
    ...
    switch(n)
    {
        ...
        {
            TimeReference=600f,SeparationThreshold=0.5f,MaxScale=1f,GrowthTime=0f,GrowthDuration=600f*0.5f,TimeSinceLastDivision=0f,DivisionInterval=600f*0.5f,HasGeneratedChild=false,Parent=Entity.Null,IsInitialCell=true,SeparationSign=0
        }
        );
        ...
        {
            TimeReference=7200f,SeparationThreshold=0.9f,MaxScale=5f,GrowthTime=0f,GrowthDuration=7200f*0.9f,TimeSinceLastDivision=0f,DivisionInterval=7200f*0.9f,HasGeneratedChild=false,Parent=Entity.Null,IsInitialCell=true,SeparationSign=0
        }
        );
        break;
