...
private void CrearEntidad(Vector3 p)
{
    ...
    switch(n)
    {
        ...
        {
            TimeReference=1800f,SeparationThreshold=0.8f,MaxScale=5f,GrowthTime=0f,GrowthDuration=1800f*0.8f,TimeSinceLastDivision=0f,DivisionInterval=1800f*0.8f,HasGeneratedChild=false,Parent=Entity.Null,IsInitialCell=true,SeparationSign=0
        }
        );
        break;
