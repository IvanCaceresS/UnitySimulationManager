...
private void CrearEntidad(Vector3 p)
{
    ...
    switch(n)
    {
        ...
        {
            TimeReference=1500f,SeparationThreshold=0.75f,MaxScale=1f,GrowthTime=0f,GrowthDuration=1500f*0.75f,TimeSinceLastDivision=0f,DivisionInterval=1500f*0.75f,HasGeneratedChild=false,Parent=Entity.Null,IsInitialCell=true,SeparationSign=0
        }
        );
        break;
        case "SCerevisiae":entityManager.AddComponentData(e,new SCerevisiaeComponent
        {
            TimeReference=6000f,SeparationThreshold=0.65f,MaxScale=5f,GrowthTime=0f,GrowthDuration=6000f*0.65f,TimeSinceLastDivision=0f,DivisionInterval=6000f*0.65f,HasGeneratedChild=false,Parent=Entity.Null,IsInitialCell=true,SeparationSign=0
        }
        );
        break;
