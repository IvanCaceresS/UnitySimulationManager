...
public static class PrefabMaterialCreator
{
    ...
    [MenuItem("Tools/Crear Prefabs y Materiales")]public static void CreatePrefabsAndMaterials()
    {
        ...
        CPAM("EColi_1",PrimitiveType.Capsule,new Vector3(.5f,1,.5f),new Vector3(90,0,0),1);
        CPAM("EColi_2",PrimitiveType.Capsule,new Vector3(.5f,1,.5f),new Vector3(90,0,0),1);
    ...
    static void CPAM(string n,PrimitiveType t,Vector3 s,Vector3 r,int c)
    {
        ...
        if(c == 1) o.AddComponent<CapsuleCollider>();
        else o.AddComponent<SphereCollider>();
        ...
        if(n=="EColi_1") m.color=new Color(0,1,0,1);
        else if(n=="EColi_2") m.color=new Color(1,1,0,1);
