...
private void CrearEntidad(Vector3 p)
{
    ...
    switch(n)
    {
        ...
        {
            TimeReference=900f,SeparationThreshold=0.6f,MaxScale=1f,GrowthTime=0f,GrowthDuration=900f*0.6f,TimeSinceLastDivision=0f,DivisionInterval=900f*0.6f,HasGeneratedChild=false,Parent=Entity.Null,IsInitialCell=true,SeparationSign=0
        }
        );
        ...
        {
            TimeReference=1500f,SeparationThreshold=0.7f,MaxScale=1f,GrowthTime=0f,GrowthDuration=1500f*0.7f,TimeSinceLastDivision=0f,DivisionInterval=1500f*0.7f,HasGeneratedChild=false,Parent=Entity.Null,IsInitialCell=true,SeparationSign=0
        }
        );
        entityManager.AddComponent(e,typeof(NonUniformScale));
        entityManager.SetComponentData(e,new NonUniformScale
