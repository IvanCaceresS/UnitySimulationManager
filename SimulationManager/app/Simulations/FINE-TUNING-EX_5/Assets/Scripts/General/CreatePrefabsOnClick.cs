...
private void CrearEntidad(Vector3 p)
{
    ...
    switch(n)
    {
        ...
        {
            TimeReference=1320f,SeparationThreshold=0.68f,MaxScale=1f,GrowthTime=0f,GrowthDuration=1320f*0.68f,TimeSinceLastDivision=0f,DivisionInterval=1320f*0.68f,HasGeneratedChild=false,Parent=Entity.Null,IsInitialCell=true,SeparationSign=0
        }
        );
        ...
        {
            TimeReference=3300f,SeparationThreshold=0.77f,MaxScale=5f,GrowthTime=0f,GrowthDuration=3300f*0.77f,TimeSinceLastDivision=0f,DivisionInterval=3300f*0.77f,HasGeneratedChild=false,Parent=Entity.Null,IsInitialCell=true,SeparationSign=0
        }
        );
        break;
