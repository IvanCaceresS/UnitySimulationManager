...
public partial class SCerevisiae_2System : SystemBase
{
    protected override void OnUpdate()
    {
        ...
        Dependency=Entities.WithReadOnly(parentMap).ForEach((Entity entity,int entityInQueryIndex,ref LocalTransform transform,ref SCerevisiae_2Component organism)=>
        {   
...
if(transform.Scale>=maxScale)
{
    ...
    {
        Unity.Mathematics.Random rng=new Unity.Mathematics.Random((uint)(entityInQueryIndex+1)*54321);
