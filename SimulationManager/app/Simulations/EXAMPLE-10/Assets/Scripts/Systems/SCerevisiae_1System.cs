...
public partial class SCerevisiae_1System : SystemBase
{
    protected override void OnUpdate()
    {
        ...
        Dependency=Entities.WithReadOnly(parentMap).ForEach((Entity entity,int entityInQueryIndex,ref LocalTransform transform,ref SCerevisiae_1Component organism)=>
        {   
...
if(transform.Scale>=maxScale)
{
    ...
    if(organism.TimeSinceLastDivision>=organism.DivisionInterval)
    {
        ...
        ct.Scale=0.01f;
        SCerevisiae_1Component cd=organism;
